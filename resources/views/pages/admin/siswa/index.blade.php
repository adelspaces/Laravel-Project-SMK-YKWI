                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header d-flex justify-content-between">
                            ...
                            {{-- ini manggil ke auth.register_siswa --}}
                            {{-- <a href="{{ route('register.siswa') }}" class="btn btn-primary">
                                + Tambah Akun Siswa
                            </a> --}}

                            {{-- <a href="{{ route('siswa.daftar') }}" class="btn btn-primary">Tambah Materi</a> --}}

                            {{-- ini yang defaut, tampilannya mirip nambah jurusan, tapi munusnya ini cuma tertambah di 1 tabel siswa doang, tabel user gak keisi --}}
                                ...
                                <form action="{{ route('siswa.store') }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <div>
                                                <small>
                                                    <a href="{{ route('register.siswa') }} " target="_blank">
                                                        Tambah siswa sebagai user
                                                    </a>
                                                </small>
                                            </div>
                                        </div>
