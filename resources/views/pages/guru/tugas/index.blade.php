                    ...
                    <div class="card">
                        <div class="card-header d-flex justify-content-between">
                            ...
                            {{-- <button class="btn btn-primary" data-toggle="modal" data-target="#exampleModal"><i
                                    class="nav-icon fas fa-folder-plus"></i>&nbsp; Tambah Tugas</button> --}}
                        </div>
                        <div class="card-body">
                                                ...
                                                <td>
                                                    <div class="d-flex">
                                                        <a class="btn btn-primary btn-sm mr-2"
                                                            href="{{ route('tugas.show', $data->id) }}"><i
                                                                class="nav-icon fas fa-eye"></i>&nbsp; Lihat jawaban</a>
                                                        <a href="{{ route('tugas.edit', Crypt::encrypt($data->id)) }}"
                                                            class="btn btn-success btn-sm"><i
                                                                class="nav-icon fas fa-edit"></i> &nbsp; Edit</a>
                                                        <form method="POST"
                                                            action="{{ route('tugas.destroy', $data->id) }}">
                                                            @csrf
                                                            @method('delete')
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea id="deskripsi" name="deskripsi" class="form-control @error('deskripsi') is-invalid @enderror"
                                                    placeholder="{{ __('deskripsi tugas') }}"></textarea>
                                            </div>
                                            <div class="form-group">
