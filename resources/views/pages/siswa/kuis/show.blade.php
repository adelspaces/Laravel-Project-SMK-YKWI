        ...
        <div class="section-body">
            <div class="row">
                <div class="col-10">
                    ...
                    <form id="formKuis" action="{{ route('siswa.kuis.storeJawaban', $kuis->id) }}" method="POST">
                        @csrf

                        {{-- 🔁 gunakan $banksoals (bukan $kuis->banksoals) agar efek acak dipakai --}}
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        let waktuTersisa = {{ max(0, \Carbon\Carbon::parse($kuis->waktu_selesai)->timestamp - now()->timestamp) }};
