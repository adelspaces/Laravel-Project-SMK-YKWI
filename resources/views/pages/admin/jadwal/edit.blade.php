                        ...
                        <form method="POST" action="{{ route('jadwal.update', $jadwal->id) }}">
                            ...
                            <div class="form-group">
                                ...
                                <select id="mapel_id" name="mapel_id" class="select2 form-control ">
                                    ...
                                    <option value="{{ $mapelItem->id ?? '' }}" {{ $jadwal->mapel_id == $mapelItem->id ? 'selected' : '' }}>{{ $mapelItem->nama_mapel ?? '' }}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="form-group">
                                ...
                                <select id="kelas_id" name="kelas_id" class="select2 form-control ">
                                    ...
                                    <option value="{{ $kelasItem->id ?? '' }}" {{ $jadwal->kelas_id == $kelasItem->id ? 'selected' : '' }}>{{ $kelasItem->nama_kelas ?? '' }}</option>
                                    @endforeach
                                </select>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <select id="guru_id" name="guru_id" class="select2 form-control ">
                                    ...
                                    <option value="{{ $guruItem->id }}" {{ $jadwal->guru_id == $guruItem->id ? 'selected' : '' }}>{{ $guruItem->nama }}</option>
                                    @endforeach
                                </select>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="time" name="dari_jam" id="time1" @error('dari_jam') is-invalid @enderror" placeholder="{{ __('Jam mulai pelajaran') }}" value="{{ $jadwal->dari_jam ?? '' }}" />

                            </div>
                            <div class="form-group">
                                <label for="sampai_jam">Sampai dari jam</label>
                                <input class="form-control" type="time" name="sampai_jam" id="time2" @error('sampai_jam') is-invalid @enderror" placeholder="{{ __('Nama Jurusan') }}" value="{{ $jadwal->sampai_jam ?? '' }}" />
                            </div>
