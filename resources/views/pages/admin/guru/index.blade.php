                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header d-flex justify-content-between">
                            <h4>List Guru</h4>
                            {{-- <a href="{{ route('register.guru') }}" class="btn btn-primary">
                                + Tambah Akun Guru
                            </a> --}}
                        ...
                        <div class="card-body">
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped" id="table-2">
                                    ...
                                    <tbody>
                                        @foreach ($guru as $result => $guruItem)
                                            <tr>
                                                ...
                                                <td>
                                                    @if ($guruItem->mapel)
                                                        {{ $guruItem->mapel->nama_mapel }}{{ $guruItem->mapel->jurusan ? ' | ' . $guruItem->mapel->jurusan->nama_jurusan : '' }}
                                                    @else
                                                        Tidak ada mapel
                                                    @endif
                                                </td>
                                                <td>
                                                    <div class="d-flex">
                                                        <a href="{{ route('guru.show', Crypt::encrypt($guruItem->id)) }}"
                                                            class="btn btn-primary btn-sm" style="margin-right: 8px"><i
                                                                class="nav-icon fas fa-user"></i> &nbsp; Profile</a>
                                                        <a href="{{ route('guru.edit', Crypt::encrypt($guruItem->id)) }}"
                                                            class="btn btn-success btn-sm"><i
                                                                class="nav-icon fas fa-edit"></i> &nbsp; Edit</a>
                                                        <form method="POST"
                                                            action="{{ route('guru.destroy', $guruItem->id) }}">
                                                            @csrf
                                                            @method('delete')
                                ...
                                <form action="{{ route('guru.store') }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select id="mapel_id" name="mapel_id"
                                                    ...
                                                    @foreach ($mapel as $mapelItem)
                                                        <option value="{{ $mapelItem->id }}">{{ $mapelItem->nama_mapel }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                            </div>
                                            ...
                                            <div>
                                                <small>
                                                    <a href="{{ route('register.guru') }}" target="_blank">
                                                        Tambah guru sebagai user
                                                    </a>
                                                </small>
                                            </div>
                                        </div>
