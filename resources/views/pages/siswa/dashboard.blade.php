                ...
                <div class="col-12 col-sm-12 col-lg-3">
                    <div class="card card-hero" style="margin-top: 36px">
                        <div class="card-header">
                            ...
                            <div class="card-description">Jadwal kelas minggu ini</div>
                        </div>
                        <div class="card-body p-0">
                            <div class="card-body p-0">
                                <div class="tickets-list">
                                    @forelse($jadwal as $data)
                                        <div class="ticket-item">
                                            <div class="ticket-title">
                                                <h4>{{ $data->mapel->nama_mapel }} ({{ $data->kelas->nama_kelas }})</h4>
                                            </div>
                                            <div class="ticket-info">
                                                <div class="text-primary">
                                                    Hari {{ $data->hari }} | Pada jam {{ $data->dari_jam }} -
                                                    {{ $data->sampai_jam }}
                                                </div>
                                            </div>
                                        </div>
