                            ...
                            <form method="POST" action="{{ route('guru.update', $guru->id) }}"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" id="nama" name="nama"
                                        ...
                                        placeholder="{{ __('Nama Guru') }}" value="{{ $guru->nama }}">
                                </div>
                                <div class="d-flex">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="nip" name="nip"
                                            ...
                                            placeholder="{{ __('NIP Guru') }}" value="{{ $guru->nip }}">
                                    </div>
                                    <div class="form-group ml-4">
                                        <label for="no_telp">No. Telp</label>
                                        <input type="text" id="no_telp" name="no_telp"
                                            class="form-control @error('no_telp') is-invalid @enderror"
                                            placeholder="{{ __('No. TElp Guru') }}" value="{{ $guru->no_telp }}">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label>Textarea</label>
                                    <textarea id="alamat" name="alamat" class="form-control @error('alamat') is-invalid @enderror"
                                        placeholder="{{ __('Alamat') }}">{{ $guru->alamat }}</textarea>
                                </div>
                                <div class="form-group">
                                    ...
                                    <select id="mapel_id" name="mapel_id"
                                        ...
                                        @foreach ($mapel as $mapelItem)
                                            <option value="{{ $mapelItem->id }}"
                                                @if ($guru->mapel_id == $mapelItem->id) selected @endif>{{ $mapelItem->nama_mapel }}
                                            </option>
                                        @endforeach
                                    </select>
                                </div>
