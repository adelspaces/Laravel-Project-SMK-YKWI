                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped" id="table-2">
                                ...
                                <tbody>
                                    @foreach ($jadwal as $result => $jadwalItem)
                                    <tr>
                                        <td>{{ $loop->iteration }}</td>
                                        <td>{{ $jadwalItem->mapel->nama_mapel }}</td>
                                        <td>{{ $jadwalItem->kelas->nama_kelas }}</td>
                                        <td>{{ Str::ucfirst($jadwalItem->hari) }}</td>
                                        <td>{{ $jadwalItem->dari_jam }}</td>
                                        <td>{{ $jadwalItem->sampai_jam }}</td>
                                        <td>{{ $jadwalItem->guru ? $jadwalItem->guru->nama : '-' }}</td>
                                        <td>
                                            <div class="d-flex">
                                                <a href="{{ route('jadwal.edit', $jadwalItem->id) }}" class="btn btn-success btn-sm"><i class="nav-icon fas fa-edit"></i> &nbsp; Edit</a>
                                                <form method="POST" action="{{ route('jadwal.destroy', $jadwalItem->id) }}">
                                                    @csrf
                                                    @method('delete')
