                            ...
                            <form method="POST" action="{{ route('siswa.update', $siswa->id) }}"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" id="nama" name="nama"
                                        ...
                                        placeholder="{{ __('Nama Siswa') }}" value="{{ $siswa->nama }}">
                                </div>
                                <div class="d-flex">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="nis" name="nis"
                                            ...
                                            placeholder="{{ __('NIS Siswa') }}" value="{{ $siswa->nis }}">
                                    </div>
                                    <div class="form-group ml-4">
                                        <label for="telp">No. Telp</label>
                                        <input type="text" id="telp" name="telp"
                                            class="form-control @error('telp') is-invalid @enderror"
                                            placeholder="{{ __('No. TElp Siswa') }}" value="{{ $siswa->telp }}">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label>Alamat</label>
                                    <textarea id="alamat" name="alamat" class="form-control @error('alamat') is-invalid @enderror"
                                        placeholder="{{ __('Alamat') }}">{{ $siswa->alamat }}</textarea>
                                </div>
                                <div class="form-group">
